from my_gym.envs.registration import (
    registry,
    register,
    make,
    spec,
...
register(
    id="CartPole-v0",
    entry_point="my_gym.envs.classic_control:CartPoleEnv",
...
register(
    id="MountainCar-v0",
    entry_point="my_gym.envs.classic_control:MountainCarEnv",
    max_episode_steps=200,
...
register(
    ...
    entry_point="my_gym.envs.classic_control:Continuous_MountainCarEnv",
...
register(
    id="Pendulum-v1",
    entry_point="my_gym.envs.classic_control:PendulumEnv",
    max_episode_steps=200,
)

register(
    id="Acrobot-v1",
    entry_point="my_gym.envs.classic_control:AcrobotEnv",
...
register(
    id="LunarLander-v2",
    entry_point="my_gym.envs.box2d:LunarLander",
...
register(
    ...
    entry_point="my_gym.envs.box2d:LunarLanderContinuous",
    max_episode_steps=1000,
    reward_threshold=200,
)
...
register(
    id="BipedalWalker-v3",
    entry_point="my_gym.envs.box2d:BipedalWalker",
...
register(
    ...
    entry_point="my_gym.envs.box2d:BipedalWalkerHardcore",
...
register(
    id="CarRacing-v0",
    entry_point="my_gym.envs.box2d:CarRacing",
    max_episode_steps=1000,
...
register(
    id="Blackjack-v1",
    entry_point="my_gym.envs.toy_text:BlackjackEnv",
    kwargs={"sab": True, "natural": False},
)

register(
    id="FrozenLake-v1",
    entry_point="my_gym.envs.toy_text:FrozenLakeEnv",
    kwargs={"map_name": "4x4"},
...
register(
    id="CliffWalking-v0",
    entry_point="my_gym.envs.toy_text:CliffWalkingEnv",
)

register(
    id="Taxi-v3",
    entry_point="my_gym.envs.toy_text:TaxiEnv",
...
register(
    id="Thrower-v2",
    entry_point="my_gym.envs.mujoco:ThrowerEnv",
    max_episode_steps=100,
    reward_threshold=0.0,
)
...
register(
    id="Striker-v2",
    entry_point="my_gym.envs.mujoco:StrikerEnv",
    max_episode_steps=100,
    reward_threshold=0.0,
)
...
register(
    ...
    entry_point="my_gym.envs.mujoco:InvertedPendulumEnv",
    max_episode_steps=1000,
...
register(
    ...
    entry_point="my_gym.envs.mujoco:InvertedDoublePendulumEnv",
    max_episode_steps=1000,
...
register(
    id="HalfCheetah-v2",
    entry_point="my_gym.envs.mujoco:HalfCheetahEnv",
    max_episode_steps=1000,
...
register(
    id="Hopper-v2",
    entry_point="my_gym.envs.mujoco:HopperEnv",
    max_episode_steps=1000,
...
register(
    id="Swimmer-v2",
    entry_point="my_gym.envs.mujoco:SwimmerEnv",
    max_episode_steps=1000,
...
register(
    id="Ant-v2",
    entry_point="my_gym.envs.mujoco:AntEnv",
    max_episode_steps=1000,
...
register(
    id="Humanoid-v2",
    entry_point="my_gym.envs.mujoco:HumanoidEnv",
    max_episode_steps=1000,
)
...
for reward_type in ["sparse", "dense"]:
    ...
    register(
        ...
        entry_point="my_gym.envs.robotics:HandReachEnv",
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        ...
        entry_point="my_gym.envs.robotics:HandBlockEnv",
    ...
    register(
        ...
        entry_point="my_gym.envs.robotics:HandBlockTouchSensorsEnv",
        kwargs=_merge(
            {
    ...
    register(
        ...
        entry_point="my_gym.envs.robotics:HandEggEnv",
        kwargs=_merge({"target_position": "ignore", "target_rotation": "xyz"}, kwargs),
        max_episode_steps=100,
    )
    ...
    register(
        ...
        entry_point="my_gym.envs.robotics:HandEggTouchSensorsEnv",
        kwargs=_merge(
            {
                "target_position": "ignore",
                "target_rotation": "xyz",
    ...
    register(
        ...
        entry_point="my_gym.envs.robotics:HandPenEnv",
        kwargs=_merge({"target_position": "ignore", "target_rotation": "xyz"}, kwargs),
        max_episode_steps=100,
    )
    ...
    register(
        ...
        entry_point="my_gym.envs.robotics:HandPenTouchSensorsEnv",
        kwargs=_merge(
            {
                "target_position": "ignore",
                "target_rotation": "xyz",
...
register(
    id="CubeCrash-v0",
    entry_point="my_gym.envs.unittest:CubeCrash",
    reward_threshold=0.9,
)
register(
    id="CubeCrashSparse-v0",
    entry_point="my_gym.envs.unittest:CubeCrashSparse",
    reward_threshold=0.9,
)
register(
    id="CubeCrashScreenBecomesBlack-v0",
    entry_point="my_gym.envs.unittest:CubeCrashScreenBecomesBlack",
    reward_threshold=0.9,
)

register(
    id="MemorizeDigits-v0",
    entry_point="my_gym.envs.unittest:MemorizeDigits",
    reward_threshold=20,
)
