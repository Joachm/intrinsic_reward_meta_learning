...
python my_gym/envs/box2d/car_racing.py

Remember it's a powerful rear-wheel drive car -  don't press the accelerator
and turn at the same time.

Created by Oleg Klimov. Licensed on the same terms as the rest of OpenAI my_gym.
"""
import sys
import math
import numpy as np
...
from my_gym.envs.box2d.car_dynamics import Car
from my_gym.utils import seeding, EzPickle
...
class CarRacing(my_gym.Env, EzPickle):
    metadata = {
    ...
    def render(self, mode="human"):
        ...
        if self.viewer is None:
            from my_gym.envs.classic_control import rendering
