...
try:
    ...
    But if you really just want to install all my_gym dependencies and not have to think about it,
    'pip install -e .[all]' or 'pip install my_gym[all]' will do it.
    """
    )
...
class Viewer(object):
    ...
    def render(self, return_rgb_array=False):
        ...
        if return_rgb_array:
            ...
            # In https://github.com/openai/my_gym-http-api/issues/2, we
