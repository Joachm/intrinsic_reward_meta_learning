...
from my_gym.vector.vector_env import VectorEnv
from my_gym.error import (
    AlreadyPendingCallError,
    NoAsyncCallError,
    ClosedEnvironmentError,
    CustomSpaceError,
)
from my_gym.vector.utils import (
...
class AsyncVectorEnv(VectorEnv):
    ...
    observation_space : `my_gym.spaces.Space` instance, optional
        Observation space of a single environment. If `None`, then the
        observation space of the first environment is taken.

    action_space : `my_gym.spaces.Space` instance, optional
        ...
        if self.shared_memory:
            try:
                ...
                raise ValueError(
                    ...
                    "is incompatible with non-standard my_gym observation spaces "
                    "(i.e. custom spaces inheriting from `my_gym.Space`), and is "
                    "only compatible with default my_gym spaces (e.g. `Box`, "
