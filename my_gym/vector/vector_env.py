...
from my_gym.vector.utils.spaces import batch_space

__all__ = ["VectorEnv"]


class VectorEnv(my_gym.Env):
    ...
    observation_space : `my_gym.spaces.Space` instance
        Observation space of a single environment.

    action_space : `my_gym.spaces.Space` instance
