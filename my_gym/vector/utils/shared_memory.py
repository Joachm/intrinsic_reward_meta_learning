...
from my_gym.spaces import Tuple, Dict
from my_gym.error import CustomSpaceError
from my_gym.vector.utils.spaces import _Basemy_gymSpaces
...
def create_shared_memory(space, n=1, ctx=mp):
    ...
    if isinstance(space, _Basemy_gymSpaces):
        ...
        raise CustomSpaceError(
            ...
            "default my_gym spaces (e.g. `Box`, `Tuple`, "
            "`Dict`, etc...), and does not support custom "
            "my_gym spaces.".format(type(space))
        )
