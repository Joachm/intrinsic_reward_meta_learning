...
from my_gym.vector.async_vector_env import AsyncVectorEnv
from my_gym.vector.sync_vector_env import SyncVectorEnv
from my_gym.vector.vector_env import VectorEnv, VectorEnvWrapper
...
def make(id, num_envs=1, asynchronous=True, wrappers=None, **kwargs):
    ...
    Returns
    -------
    env : `my_gym.vector.VectorEnv` instance
        The vectorized environment.

    Example
    -------
    >>> import my_gym
    >>> env = my_gym.vector.make('CartPole-v1', 3)
    >>> env.reset()
    array([[-0.04456399,  0.04653909,  0.01326909, -0.02099827],
          ...
          dtype=float32)
    """
    from my_gym.envs import make as make_
