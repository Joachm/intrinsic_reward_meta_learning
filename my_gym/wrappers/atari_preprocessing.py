...
from my_gym.wrappers import TimeLimit
...
class AtariPreprocessing(my_gym.Wrapper):
    ...
    * Scale observation: optional
    ...
    def __init__(
        ...
        assert (
            cv2 is not None
        ), "opencv-python package not installed! Try running pip install my_gym[atari] to get dependencies  for atari"
        assert frame_skip > 0
