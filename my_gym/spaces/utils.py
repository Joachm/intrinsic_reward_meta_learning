...
from my_gym.spaces import Discrete
from my_gym.spaces import MultiDiscrete
from my_gym.spaces import MultiBinary
from my_gym.spaces import Tuple
from my_gym.spaces import Dict
...
def flatdim(space):
    ...
    the space is not defined in ``my_gym.spaces``.
    """
