from my_gym.utils import seeding
...
class Space(object):
    ...
    `sample()` method), and batching functions (in `my_gym.vector.VectorEnv`), are
    only well-defined for instances of spaces provided in my_gym by default.
    ...
    def __setstate__(self, state):
        ...
        # See:
        #   https://github.com/openai/my_gym/pull/2397 -- shape
        #   https://github.com/openai/my_gym/pull/1913 -- np_random
        #
        if "shape" in state:
